...
const IconImage = "https://jsarangodev.github.io/KatPost/icon.svg";
...
const firebaseConfig = {
  apiKey: "AIzaSyALEuFwSo9liPTLpZmZrP3k6UJlS02JP5o",
  authDomain: "katpost---jsa.firebaseapp.com",
  projectId: "katpost---jsa",
  storageBucket: "katpost---jsa.appspot.com",
  messagingSenderId: "344661956485",
  appId: "1:344661956485:web:7e1dee5460c6666a0596ec"
};
const app = initializeApp(firebaseConfig);
const storage = getStorage(app);
const CloudImageCompiler = () => {
  const [images, setImages] = reactExports.useState([]);
  reactExports.useEffect(() => {
    const fetchImages = async () => {
      const listRef = ref(storage, "/CatsImages");
      try {
        const response = await listAll(listRef);
        const data = await Promise.all(response.items.map((item) => getDownloadURL(item)));
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "catsImages", id: "catsImages", children: images.map((imageUrl, index) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "image", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: imageUrl, alt: `Image ${index}` }, index) }, index)) });
};
function App() {
  const [columnCount, setColumnCount] = reactExports.useState(6);
  const handleKeyDown = (event) => {
    if (event.key === "ArrowRight" && columnCount < 8) {
      setColumnCount((prevCount) => prevCount + 1);
    } else if (event.key === "ArrowLeft" && columnCount > 4) {
      setColumnCount((prevCount) => prevCount - 1);
    }
  };
  reactExports.useEffect(() => {
  ...
  reactExports.useEffect(() => {
    document.getElementById("catsImages").style.columnCount = columnCount;
  });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("figure", { className: "s1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: IconImage, alt: "Icon" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "name", children: "KatPost" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "dot", children: " • " }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "desc", children: "Low quality cats images" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("figure", { className: "s2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Copyright © JSArango" }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CloudImageCompiler, {})
  ] });
}
